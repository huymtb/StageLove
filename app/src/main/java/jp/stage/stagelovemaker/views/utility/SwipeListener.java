...
public class SwipeListener implements View.OnTouchListener {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (rightView != null && leftView != null && topView != null) {
                    ...
                    float alphaTop = (((posY - parent.getPaddingTop()) / (parent.getHeight() * OPACITY_END)));
                    //float alpha = (((posX - paddingLeft) / parentWidth) * ALPHA_MAGNITUDE );
                    //Log.i("alpha: ", Float.toString(alpha));
                    topView.setAlpha(-alphaTop);
    ...
    private boolean cardBeyondTopBorder() {
        //check if cards middle is beyond the top quarter of the screen
